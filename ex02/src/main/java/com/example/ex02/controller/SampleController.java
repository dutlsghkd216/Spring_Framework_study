...
//	외부에서 전달된 파라미터의 이름과 매개변수가 다를 경우 @RequestParam을 사용하여 어디로 전달받을 지 알려준다.
	...
	@GetMapping("/ex03")
	public String ex01(@RequestParam("data") ArrayList<String> datas) {
		log.info("datas : " + datas);
		return "ex03";
	}

	@GetMapping("/ex04")
	public String ex04(@ModelAttribute("dto") InfoDTO infoDTO) { // void가 아니여서 [/WEB-INF/views/ex04.jsp] 이거임! void면
																	// [/WEB-INF/views/ex/ex04.jsp]이렇게 뜰꺼임!
																	// ↑위 타입에 앞글자 소문자이면 키값임! infoDTO가 키임
